...
import com.universl.hp.vehicle_sale_app.adapter.EnglishSearchMotorBike;
...
public class EnglishMotorBikeActivity extends AppCompatActivity {

    private List<CarResponse> carResponses;
    public List<CarResponse> getCarResponses;
    private EnglishSearchMotorBike searchAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_motor_bike);
        ...
        progress = new ProgressDialog(EnglishMotorBikeActivity.this);
        getDetails();
        initAds();
    }
    @Override
    ...
    private void getDetails(){
        ...
        class Network extends AsyncTask<String,Void,String> implements SearchView.OnQueryTextListener{
            private ProgressDialog progress = new ProgressDialog(EnglishMotorBikeActivity.this);
            @Override
            ...
            protected void onPostExecute(String s) {
                ...
                class Network_2 extends AsyncTask<String,Void,String>{
                    ...
                    protected void onPostExecute(String s) {
                        ...
                        searchAdapter = new EnglishSearchMotorBike(EnglishMotorBikeActivity.this,getCarResponses,favoriteResponses,image_path,favorite_image_path,androidId);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Toast.makeText(EnglishMotorBikeActivity.this,getCarResponses.get(i).getVehicle_type(),Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void getCarDetails(){
        ...
        class Network extends AsyncTask<String,Void,String> implements SearchView.OnQueryTextListener {
            ...
            protected void onPostExecute(String s) {
                ...
                brand = findViewById(R.id.other_vehicle);
                listView = findViewById(R.id.listView);
                //searchAdapter = new EnglishSearchMotorBike(EnglishMotorBikeActivity.this,getCarResponses);
                listView.setAdapter(searchAdapter);
                brand.setOnQueryTextListener(this);
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            Intent intent = new Intent(EnglishMotorBikeActivity.this, MainActivity.class);
