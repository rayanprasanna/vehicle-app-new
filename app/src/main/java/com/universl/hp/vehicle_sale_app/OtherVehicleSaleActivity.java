...
import com.universl.hp.vehicle_sale_app.adapter.SearchVehicleTypeAdapter;
...
public class OtherVehicleSaleActivity extends AppCompatActivity {

    private List<CarResponse> carResponses;
    public List<CarResponse> getCarResponses;
    private SearchVehicleTypeAdapter searchAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_vehicle_sale);
        ...
        progress = new ProgressDialog(OtherVehicleSaleActivity.this);
        getDetails();
        initAds();
    }
    @Override
    ...
    private void getDetails(){
        ...
        class Network extends AsyncTask<String,Void,String> implements SearchView.OnQueryTextListener{
            private ProgressDialog progress = new ProgressDialog(OtherVehicleSaleActivity.this);
            @Override
            ...
            protected void onPostExecute(String s) {
                ...
                class Network_2 extends AsyncTask<String,Void,String>{
                    ...
                    protected void onPostExecute(String s) {
                        ...
                        searchAdapter = new SearchVehicleTypeAdapter(OtherVehicleSaleActivity.this,getCarResponses,favoriteResponses,image_path,favorite_image_path,androidId);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Toast.makeText(OtherVehicleSaleActivity.this,getCarResponses.get(i).getVehicle_type(),Toast.LENGTH_SHORT).show();
                    }
                });
            }
    ...
    private void getCarDetails(){
        ...
        class Network extends AsyncTask<String,Void,String> implements SearchView.OnQueryTextListener {
            ...
            protected void onPostExecute(String s) {
                ...
                brand = findViewById(R.id.other_vehicle);
                listView = findViewById(R.id.listView);
                //searchAdapter = new SearchVehicleTypeAdapter(OtherVehicleSaleActivity.this,getCarResponses);
                listView.setAdapter(searchAdapter);
                brand.setOnQueryTextListener(this);
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            Intent intent = new Intent(OtherVehicleSaleActivity.this, MainMenuActivity.class);
