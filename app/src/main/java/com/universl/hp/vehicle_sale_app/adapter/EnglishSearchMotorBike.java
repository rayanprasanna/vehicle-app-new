...
public class EnglishSearchMotorBike extends BaseAdapter {
    ...
    public EnglishSearchMotorBike(Context context, List<CarResponse> carResponses,
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (carResponses.get(position).getVehicle_type().equalsIgnoreCase("Scooter")
                || carResponses.get(position).getVehicle_type().equalsIgnoreCase("Motor Bike")
                && carResponses.get(position).getStatus().equalsIgnoreCase("true")){
