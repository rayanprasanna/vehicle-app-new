...
public class ServiceAdapter extends BaseAdapter {
    ...
    private List<ServiceResponse> sparePartServiceResponses;
    private ArrayList<ServiceResponse> sparePartServiceResponseArrayList ;
    public ServiceAdapter(Context context, List<ServiceResponse> sparePartServiceResponses) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.service_new_ui_list, null);
    ...
    public void filter(String charText){
        ...
        if (charText.length() == 0) {
            ...
            for (ServiceResponse response : sparePartServiceResponseArrayList) {
