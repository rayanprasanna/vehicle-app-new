...
import com.universl.hp.vehicle_sale_app.adapter.SearchServiceAdapter;
...
public class SparePartSaleActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    private SearchServiceAdapter searchAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spare_part_sale);
        ...
        progress = new ProgressDialog(SparePartSaleActivity.this);
        getDetails();
        initAds();
    }
    @Override
        ...
        JsonArrayRequest request = new JsonArrayRequest(Constants.BASE_URL_get_service,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        service_list.size();
                        searchAdapter = new SearchServiceAdapter(SparePartSaleActivity.this,remove_duplicate_category);
                        ...
                        brand.setOnQueryTextListener(SparePartSaleActivity.this);
    ...
    /*private void getDetails(){
        ...
        class Network extends AsyncTask<String,Void,String> implements SearchView.OnQueryTextListener{
            private ProgressDialog progress = new ProgressDialog(SparePartSaleActivity.this);
            @Override
            ...
            protected void onPostExecute(String s) {
                ...
                class Network_2 extends AsyncTask<String,Void,String>{
                    ...
                    protected void onPostExecute(String s) {
                        ...
                        searchAdapter = new SearchServiceAdapter(SparePartSaleActivity.this,getSparePartServiceResponses,favoriteResponses,image_path,favorite_image_path,androidId);
                        listView.setAdapter(searchAdapter);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Toast.makeText(SparePartSaleActivity.this,getSparePartServiceResponses.get(i).getService_type(),Toast.LENGTH_SHORT).show();
                    }
                });
            }
    ...
    /*private void getCarDetails(){
        ...
        class Network extends AsyncTask<String,Void,String> implements SearchView.OnQueryTextListener {
            ...
            protected void onPostExecute(String s) {
                ...
                brand = findViewById(R.id.spare_part_service);
                listView = findViewById(R.id.listView);
                searchAdapter = new SearchServiceAdapter(SparePartSaleActivity.this,getSparePartServiceResponses);
                listView.setAdapter(searchAdapter);
                brand.setOnQueryTextListener(this);
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            Intent intent = new Intent(SparePartSaleActivity.this, MainMenuActivity.class);
