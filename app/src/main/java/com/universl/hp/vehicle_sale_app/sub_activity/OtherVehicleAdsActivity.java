...
public class OtherVehicleAdsActivity extends AppCompatActivity {

    private Context context;
    public Activity activity;
    private RelativeLayout relativeLayout;
    private ArrayList<DistrictResponse> districtResponses;
    ArrayList<String> districts,cities,vehicle_types;
    Spinner district,city,vehicle_type;
    EditText year,mileage,title,description,price;
    ...
    Boolean isParseBoolean = false,isOtherVehicleActivity = false;
    TextView contact_num,name;
    int count = 0;
    private PopupWindow popupWindow;
    ArrayAdapter<String> districtAdapter,cityAdapter,vehicle_typeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_vehicle_ads);
        Objects.requireNonNull(getSupportActionBar()).setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        relativeLayout = findViewById(R.id.other_vehicle_activity);
        context = getApplicationContext();
        activity = OtherVehicleAdsActivity.this;
        district = findViewById(R.id.select_location_district_4);
        city = findViewById(R.id.select_location_city_4);
        select_image = findViewById(R.id.image_select_btn_4);
        radioGroup = findViewById(R.id.radioCondition_4);
        contact = findViewById(R.id.contact_4);
        vehicle_type = findViewById(R.id.select_vehicle_type_3);
        year = findViewById(R.id.model_year_4);
        mileage = findViewById(R.id.mileage_4);
        description = findViewById(R.id.description_4);
        price = findViewById(R.id.price_4);
        save = findViewById(R.id.save_4);
        name = findViewById(R.id.name_text_4);
        contact_num = findViewById(R.id.telephone_num_4);
        new_radio = findViewById(R.id.new_radio_4);
        title = findViewById(R.id.title_1);
        re_condition_radio = findViewById(R.id.recondition_radio_4);
        used_radio = findViewById(R.id.used_radio_4);
        ...
        RecyclerView mUploadList = findViewById(R.id.recycler_view_4);
        ...
        progress = new ProgressDialog(OtherVehicleAdsActivity.this);
        ...
        vehicle_types.add("බර වහන");vehicle_types.add("1. බුල්ඩෝසරය");vehicle_types.add("2. දොඹකරය");vehicle_types.add("3. කැණිය");vehicle_types.add("4. හෑරීම් යන්ත්\u200Dර");
        vehicle_types.add("5. ලෝඩර් / ලිෆ්ටරය");vehicle_types.add("6. රෝලර්");vehicle_types.add("7. ට්\u200Dරැක්ටරය");vehicle_types.add("සැහැල්ලු වාහන");vehicle_types.add("1. ත්\u200Dරිරෝද රථ");
        vehicle_types.add("2. පාපැදි");vehicle_types.add("3. වෙනත්");
        vehicle_typeAdapter = new ArrayAdapter<>(this,
                android.R.layout.simple_dropdown_item_1line, vehicle_types);
        vehicle_type.setAdapter(vehicle_typeAdapter);
        ...
        select_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (count <= 4){
                    ...
                    Toast.makeText(OtherVehicleAdsActivity.this,"More than 5 Images Selected",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        contact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OtherVehicleAdsActivity.this,PhoneAuthActivity.class);
                ...
                intent.putExtra("vehicle_type",vehicle_type.getSelectedItem().toString());
                ...
                intent.putExtra("isOtherVehicle",isOtherVehicleActivity);
            ...
            public void onClick(View v) {
                if (isMultipleImage){
                    if (isParseBoolean){
                        ...
                        // find the radiobutton by returned id
                        condition = findViewById(selectedId);
                        uploadOtherVehicle(district,city,multi_images,vehicle_type,year,condition.getText().toString(),mileage,description,price,contact_num,user_Uid,title);
                    }
                }else {
                    if (isParseBoolean){
                        int selectedId = radioGroup.getCheckedRadioButtonId();
                        ...
                        // find the radiobutton by returned id
                        condition = findViewById(selectedId);
                        uploadOtherVehicle(district,city,sing_images,vehicle_type,year,condition.getText().toString(),mileage,description,price,contact_num,user_Uid,title);
                    }
                }
            }
        });
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch(view.getId()) {
            case R.id.new_radio_4:
                if(checked)
                    break;
            case R.id.used_radio_4:
                if(checked)
                    break;
            case R.id.recondition_radio_4:
                if(checked)
                    break;
        }
    }
    ...
    private void open_Popup_window() {final String district_sp = getIntent().getStringExtra("district");
        ...
        if (customView != null) {
            ...
            Yes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    vehicle_type.setSelection(vehicle_typeAdapter.getPosition(vehicle_type_sp));
        ...
        findViewById(R.id.other_vehicle_activity).post(new Runnable() {
            @Override
            public void run() {
    ...
    private void uploadOtherVehicle(final Spinner district,final Spinner city,final ArrayList<String> image_Urls,
                                   final Spinner vehicle_type, final EditText year,final String condition,final EditText mileage,final EditText description,final EditText price,
                                   final TextView contact_num,final String user_Uid,final TextView title){
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>" + image_Urls.size());
        @SuppressLint("StaticFieldLeak")
        class Network extends AsyncTask<String,Void,String>{
            private ProgressDialog progress = new ProgressDialog(OtherVehicleAdsActivity.this);
            @Override
            ...
            protected String doInBackground(String... strings) {
                try {
                    ...
                    HttpPost httpPost = new HttpPost(Constants.BASE_URL_insert_other_vehicle);
                    ...
                    list.add(new BasicNameValuePair("vehicle_type",vehicle_type.getSelectedItem().toString()));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            Intent intent = new Intent(OtherVehicleAdsActivity.this, PostAdsActivity.class);
            startActivity(intent);
            this.finish();
        }
                    ...
                    fileToUpload.putFile(fileUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(OtherVehicleAdsActivity.this, "upload failed: " + Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                } else {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        if (data.getClipData() != null) {
                            ...
                            if (totalItemsSelected <= 5){
                                ...
                                Toast.makeText(OtherVehicleAdsActivity.this,"More 5 Images Selected",Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                }
