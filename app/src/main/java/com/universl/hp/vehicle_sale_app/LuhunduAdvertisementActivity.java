...
import com.universl.hp.vehicle_sale_app.adapter.SearchHitAdsAdapter;
...
public class LuhunduAdvertisementActivity extends AppCompatActivity {

    private List<HitAdsResponse> hitAdsResponses;
    public List<HitAdsResponse> getHitAdsResponses;
    private SearchHitAdsAdapter searchAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luhundu_advertisement);

        Objects.requireNonNull(getSupportActionBar()).setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        getHitAdsResponses = new ArrayList<>();
        progress = new ProgressDialog(LuhunduAdvertisementActivity.this);
        getCarDetails();
        initAds();
    }
    @Override
    ...
    private void getCarDetails(){
        ...
        class Network extends AsyncTask<String,Void,String> implements SearchView.OnQueryTextListener {
            private ProgressDialog progress = new ProgressDialog(LuhunduAdvertisementActivity.this);
            @Override
            ...
            protected void onPostExecute(String s) {
                ...
                searchAdapter = new SearchHitAdsAdapter(LuhunduAdvertisementActivity.this,getHitAdsResponses);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            Intent intent = new Intent(LuhunduAdvertisementActivity.this, MainMenuActivity.class);
