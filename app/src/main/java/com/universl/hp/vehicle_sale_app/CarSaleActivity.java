...
import com.universl.hp.vehicle_sale_app.adapter.SearchAdapter;
...
public class CarSaleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(CarSaleActivity.this);
        getDetails();
        initAds();
    }
    ...
    private void getDetails(){
        ...
        class Network extends AsyncTask<String,Void,String> implements SearchView.OnQueryTextListener{
            private ProgressDialog progress = new ProgressDialog(CarSaleActivity.this);
            @Override
            ...
            protected void onPostExecute(String s) {
                ...
                class Network_2 extends AsyncTask<String,Void,String>{
                    ...
                    protected void onPostExecute(String s) {
                        ...
                        searchAdapter = new SearchAdapter(CarSaleActivity.this,getCarResponses,favoriteResponses,image_path,favorite_image_path,androidId);
    ...
    private void getCarDetails(){
        ...
        class Network extends AsyncTask<String,Void,String> implements SearchView.OnQueryTextListener {
            ...
            protected void onPostExecute(String s) {
                ...
                brand = findViewById(R.id.brand);
                listView = findViewById(R.id.listView);
                //searchAdapter = new SearchAdapter(CarSaleActivity.this,getCarResponses);
                listView.setAdapter(searchAdapter);
                brand.setOnQueryTextListener(this);
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            Intent intent = new Intent(CarSaleActivity.this, MainMenuActivity.class);
