...
public class EnglishSearchHitAdsAdapter extends BaseAdapter {
    ...
    public EnglishSearchHitAdsAdapter(Context context, List<HitAdsResponse> hitAdsResponses) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null){
            ...
            view = layoutInflater.inflate(R.layout.english_hit_ads_list, null);
