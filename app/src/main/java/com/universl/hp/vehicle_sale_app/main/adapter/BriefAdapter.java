...
public class BriefAdapter extends BaseAdapter {
    ...
    private List<BriefResponse> hitAdsResponses;
    private ArrayList<BriefResponse> hitAdsResponseArrayList;


    public BriefAdapter(Context context, List<BriefResponse> hitAdsResponses) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null){
            ...
            view = layoutInflater.inflate(R.layout.brief_ads_list, null);
    ...
    public void filter_title(String charText){
        ...
        if (charText.length() == 0) {
            ...
            for (BriefResponse response : hitAdsResponseArrayList) {
