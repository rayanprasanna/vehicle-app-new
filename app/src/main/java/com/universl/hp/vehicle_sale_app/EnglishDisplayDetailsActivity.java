...
public class EnglishDisplayDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_display_details);

        type = getIntent().getStringExtra("activity");

        Objects.requireNonNull(getSupportActionBar()).setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        progress = new ProgressDialog(EnglishDisplayDetailsActivity.this);

        relativeLayout = findViewById(R.id.coordinate_layout);
        context = getApplicationContext();
        activity = EnglishDisplayDetailsActivity.this;
            ...
            protected void onPostExecute(String s) {
                ...
                for (int i = 0; i < carResponses.size(); i++){
                    if (carResponses.get(i).getImage_path_1().equals(image)){
                        ...
                        if (!carResponses.get(i).getImage_path_2().isEmpty()){
                            image_path.add(carResponses.get(i).getImage_path_2());
                        } if (!carResponses.get(i).getImage_path_3().isEmpty()){
                            image_path.add(carResponses.get(i).getImage_path_3());
                        }
                        if (!carResponses.get(i).getImage_path_4().isEmpty()){
                            image_path.add(carResponses.get(i).getImage_path_4());
                        } if (!carResponses.get(i).getImage_path_5().isEmpty()){
                ...
                LinearLayoutManager layoutManager = new LinearLayoutManager(EnglishDisplayDetailsActivity.this,LinearLayoutManager.HORIZONTAL,false);
                RecyclerView mUploadList = findViewById(R.id.recycler_view);
                mUploadList.setLayoutManager(layoutManager);
                detailsAdapter = new DetailsAdapter(EnglishDisplayDetailsActivity.this,image_path);
                ...
                BaseAdapter baseAdapter = new BaseAdapter() {
                    ...
                    public View getView(final int position, View convertView, ViewGroup parent) {
                        convertView = LayoutInflater.from(EnglishDisplayDetailsActivity.this).inflate(R.layout.english_full_vehicle_details, null);
                        ...
                        engine.setText(getCarResponses.get(position).getEngine_capacity());
                        mileage.setText(getCarResponses.get(position).getMileage());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            switch (type) {
                case "service": {
                    Intent intent = new Intent(EnglishDisplayDetailsActivity.this, EnglishSparePartSaleActivity.class);
                    startActivity(intent);
                    this.finish();
                    break;
                }
                case "other": {
                    Intent intent = new Intent(EnglishDisplayDetailsActivity.this, EnglishOtherVehicleSaleActivity.class);
                    startActivity(intent);
                    this.finish();
                    break;
                }
                case "favorites":{
                    Intent intent = new Intent(EnglishDisplayDetailsActivity.this, DisplayFavoriteActivity.class);
                    startActivity(intent);
                    this.finish();
                    break;
                }
                case "main":{
                    Intent intent = new Intent(EnglishDisplayDetailsActivity.this, MainActivity.class);
                    startActivity(intent);
                    this.finish();
                    break;
                }
                default: {
                    Intent intent = new Intent(EnglishDisplayDetailsActivity.this, CarSaleActivity.class);
                    startActivity(intent);
                    this.finish();
                    break;
                }
        ...
        if (id == R.id.share){
            shareDialog.registerCallback(callbackManager, new FacebookCallback<Sharer.Result>() {
                ...
                public void onSuccess(Sharer.Result result) {
                    Toast.makeText(EnglishDisplayDetailsActivity.this,"Share successful!",Toast.LENGTH_LONG).show();
                }

                @Override
                public void onCancel() {
                    Toast.makeText(EnglishDisplayDetailsActivity.this,"Share cancel!",Toast.LENGTH_LONG).show();
                }

                @Override
                public void onError(FacebookException error) {
                    Toast.makeText(EnglishDisplayDetailsActivity.this,error.getMessage(),Toast.LENGTH_LONG).show();
                }
            });
            ShareLinkContent linkContent = new ShareLinkContent.Builder()
                    .setQuote("# වාහන")
                    .setContentUrl(Uri.parse("https://play.google.com/store/apps/details?id=com.universl.hp.vehicle_sale_app"))
                    .build();
        ...
        if (id == R.id.go_home){
            Intent intent = new Intent(EnglishDisplayDetailsActivity.this, MainMenuActivity.class);
            startActivity(intent);
            this.finish();
        }
    ...
    public void onBackPressed() {
        ...
        switch (type) {
            ...
            default: {
                Intent intent = new Intent(EnglishDisplayDetailsActivity.this, EnglishCarSaleActivity.class);
                startActivity(intent);
                this.finish();
                break;
            }
