...
public class CarAdsActivity extends AppCompatActivity {
    ...
    ArrayList<String> districts,cities, models,brands,transmissions,fuels;
    Spinner district,city,brand,model,body,transmission,fuel;
    EditText trim,year,mileage,capacity,description,price;
    ...
    Boolean isParseBoolean = false;
    TextView contact_num,name;
    int count = 0;
    private PopupWindow popupWindow;
    SpinnerAdapter stringArrayAdapter;
    ArrayAdapter<String> dataAdapter,dataAdapter_2,adapter,arrayAdapter,transmissionAdapter,fuelAdapter;
    private String user_name,user_Uid,body_type_string;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout = findViewById(R.id.car_ads_activity);
        context = getApplicationContext();
        activity = CarAdsActivity.this;
        district = findViewById(R.id.select_location_district_1);
        city = findViewById(R.id.select_location_city_1);
        brand = findViewById(R.id.select_brand_1);
        model = findViewById(R.id.select_model_1);
        body = findViewById(R.id.select_body_type_1);
        transmission = findViewById(R.id.select_transmission_1);
        fuel = findViewById(R.id.select_fuel_1);
        select_image = findViewById(R.id.image_select_btn_1);
        radioGroup = findViewById(R.id.radioCondition_1);
        contact = findViewById(R.id.contact_1);
        trim = findViewById(R.id.trim_1);
        year = findViewById(R.id.model_year_1);
        mileage = findViewById(R.id.mileage_1);
        capacity = findViewById(R.id.capacity_1);
        description = findViewById(R.id.description_1);
        price = findViewById(R.id.price_1);
        save = findViewById(R.id.save_1);
        name = findViewById(R.id.name_text_1);
        contact_num = findViewById(R.id.telephone_num_1);
        new_radio = findViewById(R.id.new_radio_1);
        re_condition_radio = findViewById(R.id.recondition_radio_1);
        used_radio = findViewById(R.id.used_radio_1);
        ...
        brands.add("Alfa Romeo");brands.add("Aston Martin");brands.add("Audi");brands.add("Austin");brands.add("BMW");
        brands.add("Buick");brands.add("Cadillac");brands.add("Changan");brands.add("Chery");brands.add("Chevrolet");
        brands.add("Chrysler");brands.add("Citroen");brands.add("Daewoo");brands.add("Daihatsu");brands.add("Datsun");
        brands.add("DFSK");brands.add("Dodge");brands.add("Ferrari");brands.add("Fait");brands.add("Ford");
        brands.add("Geely");brands.add("GMC");brands.add("Hino");brands.add("Honda");brands.add("Hummer");brands.add("Hyundai");
        brands.add("Isuzu");brands.add("Jaguar");brands.add("Jeep");brands.add("Kia");brands.add("Lamborghini");brands.add("Land Rover");
        brands.add("Lexus");brands.add("Lincoln");brands.add("Mahindra");brands.add("Maruti Suzuki");brands.add("Maruti");
        brands.add("Mazda");brands.add("Mercedes Benz");brands.add("MG");brands.add("Micro");brands.add("Mini");brands.add("Mitsubishi");
        brands.add("Morris");brands.add("Moto Guzzi");brands.add("Nissan");brands.add("Oldsmobile");brands.add("Opel");
        brands.add("Perodua");brands.add("Peugeot");brands.add("Plymoth");brands.add("Pontiac");brands.add("Porsche");brands.add("Proton");
        brands.add("Renault");brands.add("Rover");brands.add("Royal Enfield");brands.add("Saab");brands.add("Scion");brands.add("SEAT");
        brands.add("Skoda");brands.add("Smart");brands.add("Ssang Yong");brands.add("Subaru");brands.add("Suzuki");brands.add("Tata");
        brands.add("Tesla");brands.add("Toyota");brands.add("Vauxhall");brands.add("Volkswagen");brands.add("Volvo");brands.add("Zotye");

        bodies.add(new ItemData("ඛඳ වර්ගය",R.drawable.vehicle));
        bodies.add(new ItemData("සැලූන් රථ",R.drawable.super_saloon));
        bodies.add(new ItemData("හැට්ච්බැක්",R.drawable.hatchback));
        bodies.add(new ItemData("ස්ටේශන් වැගන්",R.drawable.station_wagon));bodies.add(new ItemData("කන්වර්ටිබල් මෝටර් රථ",R.drawable.convertible));
        bodies.add(new ItemData("වහලක් සහිත දොර දෙකේ මෝටර් රථ",R.drawable.sport));
        bodies.add(new ItemData("SUV / 4X4",R.drawable.suv));bodies.add(new ItemData("බහු කාර්ය වාහන",R.drawable.mpv));

        transmissions.add("කායික ගියර් සහිත මෝටර් රථ");transmissions.add("ස්වයංක්\u200Dරීය ගියර් සහිත මෝටර් රථ");
        transmissions.add("ටිප්ට්\u200Dරොනික්");transmissions.add("වෙනත් ගියර පද්ධති");
        fuels.add("ඩීසල්");fuels.add("පෙට්රල්");
        fuels.add("CNG ඉන්ධන");fuels.add("වෙනත් ඉන්ධන වර්ග");
        progress = new ProgressDialog(CarAdsActivity.this);
        load_districts();
        ...
        dataAdapter_2 = new ArrayAdapter<>(this,
                android.R.layout.simple_dropdown_item_1line,cities);
        city.setAdapter(dataAdapter_2);
        ...
        stringArrayAdapter = new SpinnerAdapter(this,R.layout.spinner_layout,R.id.body_type_id,bodies);
        body.setAdapter(stringArrayAdapter);
        transmissionAdapter = new ArrayAdapter<>(this,
                android.R.layout.simple_dropdown_item_1line,transmissions);
        transmission.setAdapter(transmissionAdapter);
        fuelAdapter = new ArrayAdapter<>(this,
        ...
        select_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (count <= 4){
                    ...
                    Toast.makeText(CarAdsActivity.this,"More than 5 Images Selected",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        contact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CarAdsActivity.this,PhoneAuthActivity.class);
                ...
                intent.putExtra("body_type",body.getSelectedItemPosition());
                intent.putExtra("transmission",transmission.getSelectedItem().toString());
                intent.putExtra("fuel",fuel.getSelectedItem().toString());
            ...
            public void onClick(View v) {
               if (isMultipleImage){
                   if (isParseBoolean){
                       ...
                       // find the radiobutton by returned id
                       condition = findViewById(selectedId);
                       final int body_type_sp = getIntent().getIntExtra("body_type",0);

                       System.out.println("}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}" + body_type_string);
                       upLoadCar(district,city,multi_images,brand,model,trim,year,condition.getText().toString(),mileage,stringArrayAdapter.getList(body_type_sp).getText(),
                               transmission,fuel,capacity,description,price,contact_num,user_Uid,"කාර්",body);
                   }
               }else {
                   if (isParseBoolean){
                       int selectedId = radioGroup.getCheckedRadioButtonId();
                       ...
                       condition = findViewById(selectedId);
                       final int body_type_sp = getIntent().getIntExtra("body_type",0);
                       upLoadCar(district,city,sing_images,brand,model,trim,year,condition.getText().toString(),mileage,stringArrayAdapter.getList(body_type_sp).getText(),
                               transmission,fuel,capacity,description,price,contact_num,user_Uid,"කාර්",body);
                   }
               }
            }
        ...
        if (isParseBoolean){
            ...
            body.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    body_type_string = parent.getItemAtPosition(position).toString();
                }
    ...
    private void open_Popup_window(){
        ...
        final String fuel_sp = getIntent().getStringExtra("fuel");
        ...
        final String transmission_sp = getIntent().getStringExtra("transmission");
        ...
        if (customView != null) {
            ...
            Yes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    district.setSelection(dataAdapter.getPosition(district_sp));
                    //System.out.println("//////////////------------>"+dataAdapter.getPosition(district_sp));
                    brand.setSelection(adapter.getPosition(brand_sp));
                    body.setSelection(body_type_sp);
                    fuel.setSelection(fuelAdapter.getPosition(fuel_sp));
                    transmission.setSelection(transmissionAdapter.getPosition(transmission_sp));
            ...
            exit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    city.setSelection(dataAdapter_2.getPosition(city_sp));
                    model.setSelection(arrayAdapter.getPosition(model_sp));
                    popupWindow.dismiss();
                }
            });
        ...
        findViewById(R.id.car_ads_activity).post(new Runnable() {
            @Override
            public void run() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            Intent intent = new Intent(CarAdsActivity.this, PostAdsActivity.class);
            startActivity(intent);
            this.finish();
        }
    ...
    private void upLoadCar(final Spinner district,final Spinner city,final ArrayList<String> image_Urls,
                           final Spinner brand,final Spinner model,final EditText trim,
                           final EditText year,final String condition,final EditText mileage,
                           final String body_string,final Spinner transmission,final Spinner fuel
                            , final EditText capacity,final EditText description,final EditText price,
                           final TextView contact_num,final String user_Uid,final String vehicleType,final Spinner body){
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>" + image_Urls.size());
        @SuppressLint("StaticFieldLeak")
        class Network extends AsyncTask<String,Void,String>{
            private ProgressDialog progress = new ProgressDialog(CarAdsActivity.this);
            @Override
            ...
            protected String doInBackground(String... strings) {
                try {
                    ...
                    HttpPost httpPost = new HttpPost(Constants.BASE_URL_insert_car);
                    ...
                    list.add(new BasicNameValuePair("body_type",body_string));
                    ...
                    list.add(new BasicNameValuePair("transmission", transmission.getSelectedItem().toString()));
                    list.add(new BasicNameValuePair("model_year",year.getText().toString()));
                    list.add(new BasicNameValuePair("fuel_type", fuel.getSelectedItem().toString()));
                    ...
                    fileToUpload.putFile(fileUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(CarAdsActivity.this, "upload failed: " + Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                } else {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        if (data.getClipData() != null) {
                            ...
                            if (totalItemsSelected <= 5){
                                ...
                                Toast.makeText(CarAdsActivity.this,"More 5 Images Selected",Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                }
