...
public class EnglishSearchBrand extends BaseAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    private ArrayList<CarResponse> carResponseArrayList;
    ...
    public EnglishSearchBrand(Context context,
                              List<CarResponse> carResponses, List<FavoriteResponse> favoriteResponses,
                              List<String> image_paths, List<String> my_favorite_image_path, String user_id) {
        this.context = context;
        //this.vehicleAds = vehicleAds;
        layoutInflater = LayoutInflater.from(context);

        carResponseArrayList = new ArrayList<>();
        //vehicleAdsArrayList.addAll(vehicleAds);
        carResponseArrayList.addAll(carResponses);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.vahana_ad_details, null);

            // Locate the TextViews in listView_item.xml
            viewHolder.brand = convertView.findViewById(R.id.brand);
            viewHolder.model = convertView.findViewById(R.id.model);
            viewHolder.year = convertView.findViewById(R.id.year);
            viewHolder.price = convertView.findViewById(R.id.price);
            viewHolder.relativeLayout = convertView.findViewById(R.id.image_details);
            viewHolder.favorite = convertView.findViewById(R.id.title_favorite);
            viewHolder.like_count = convertView.findViewById(R.id.title_like);
            //viewHolder.image = convertView.findViewById(R.id.selected_image);

            viewHolder.photo = convertView.findViewById(R.id.photoView);
        ...
        /*viewHolder.image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("image_path_1",vehicleAds.get(position).getImage_path());
                context.startActivity(intent);
                ((Activity)context).finish();
            }
        });*/
        ...
        /*Picasso.with(context)
                .load(vehicleAds.get(position).getImage_path())
                .resize(500,500)
                .centerInside()
    ...
    public void filter_brand(String charText){
        ...
        if (charText.length() == 0) {
            carResponses.addAll(carResponseArrayList);
        } else {
            for (CarResponse response : carResponseArrayList) {
