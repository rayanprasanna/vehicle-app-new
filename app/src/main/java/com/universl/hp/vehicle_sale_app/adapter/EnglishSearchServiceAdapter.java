...
import com.universl.hp.vehicle_sale_app.EnglishServiceStationActivity;
...
public class EnglishSearchServiceAdapter extends BaseAdapter {
    ...
    public EnglishSearchServiceAdapter(Context context, List<String> service) {
    ...
    public EnglishSearchServiceAdapter(Context context, List<SparePartServiceResponse>sparePartServiceResponses, List<FavoriteResponse>favoriteResponses, List<String>image_paths, List<String>my_favorite_image_path, String user_id){
        this.context = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        viewHolder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,EnglishServiceStationActivity.class);
