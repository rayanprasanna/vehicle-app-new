...
public class SearchBrand extends BaseAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    private List<CarResponse> carResponses,carResponseList;
    ...
    public SearchBrand(Context context,
        ...
        carResponseList = new ArrayList<>();
        carResponseList.addAll(carResponses);
    ...
    public void filter_brand(String charText){
        ...
        if (charText.length() == 0) {
            carResponses.addAll(carResponseList);
        } else {
            for (CarResponse response : carResponseList) {
